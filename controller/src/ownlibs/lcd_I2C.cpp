...
LCD_I2C::LCD_I2C(const uint8_t i_ui8_lcd_address, const int i_red_pin, const int i_green_pin, const int i_blue_pin, const uint8_t i_ui8_nb_row = 4, const uint8_t i_ui8_nb_column = 20) {
...
void LCD_I2C::backlight_brightness(int brightness) {
...
void LCD_I2C::backlight_setColor(int r, int g, int b) {
	if (this->backlight) {
